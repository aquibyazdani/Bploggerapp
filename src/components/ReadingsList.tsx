...
import { Pencil, Trash2, Heart, Armchair, User, Bed, BarChart2 } from 'lucide-react';
...
export function ReadingsList({ readings, onEdit, onDelete, editingId }: ReadingsListProps) {
                    ...
                    >
                      ...
                      <td style={styles.dataCell}>
                        <div style={styles.dateTimeCell}>
                          <span style={styles.dateText}>{formatDate(reading.timestamp)}</span>
                          <span style={styles.timeText}>{formatTime(reading.timestamp)}</span>
                        </div>
                      </td>
                      ...
                      <td style={styles.dataCell}>
                        {reading.pulse ? (
                          <div style={styles.pulseCell}>
                            ...
                            <span style={styles.pulseText}>{reading.pulse}</span>
                          </div>
                        ) : (
